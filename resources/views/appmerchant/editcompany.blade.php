        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
				 <div class = 'floatleft'><h1 class='text-dark fw-bolder fs-2 margintop7'> Edit Companies </h1></div> 
                ...
                <div class="card-body">
					<div class="card-body">
						{!! Form::model($row, ['route' => ['CompanyUpdate.route', $row->id],
						'method' => 'PATCH',
						'class' => 'form',
						 'files' => true
						,'enctype'=>'multipart/form-data'
							...
							<div class="form-group row">
								...
								<img src="<?php echo asset("images/company/thumb/{$row->logo}")?>" style = 'margin-top:10px;clear:both'>
								</div>
								@endif
							</div>
