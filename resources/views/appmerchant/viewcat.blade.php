...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"> <h1 class='text-dark fw-bolder fs-2 margintop7'> Categories </h1> 
					<a  href ='/appmerchant/addcat' 
					class='edit btn btn-primary btn-sm margintop7 paddtop6'> <b> Add Category </b> </a>
				</div>
                <div class="card-body">
                    
					
					<form method = 'post' action = "/appmerchant/cat/deleteall">
