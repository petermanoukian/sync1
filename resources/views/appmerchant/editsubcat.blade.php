    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
			...
			<div class="card-header">
               <div class = 'floatleft'><h1 class='text-dark fw-bolder fs-2 margintop7'> Edit Sub Category </h1></div> 
			    <div class = 'floatleft'>
				<a  href ='/appmerchant/viewcat'
				class='edit btn btn-primary btn-sm margintop7 paddtop6 bold left'>&rsaquo; Categories </a>
				<a  href ='/appmerchant/addcat'
				class='edit btn btn-primary btn-sm margintop7 paddtop6 bold left'>&rsaquo; Add Categories </a>
				<a  href ='/appmerchant/viewsubcat'
				class='edit btn btn-primary btn-sm margintop7 paddtop6 bold left'>&rsaquo; Sub Categories </a>
				<a  href ='/appmerchant/addsubcat'
				class='edit btn btn-primary btn-sm margintop7 paddtop6 bold left'>&rsaquo; Add Sub Categories </a>
                ...
                <div class="card-body">
					<div class="card-body">
						{!! Form::model($row, ['route' => ['subCatUpdate.route', $row->id],
						'method' => 'PATCH',
						'class' => 'form',
						 'files' => true
						,'enctype'=>'multipart/form-data'
							...
							<div class="form-group row">
								...
								<img src="<?php echo asset("images/subcat/thumb/{$row->logo}")?>" style = 'margin-top:10px;clear:both'>
								</div>
								@endif
							</div>
