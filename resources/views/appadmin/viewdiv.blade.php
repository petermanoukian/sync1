        ...
        <div class="col-md-12">
            <div class="card">
				...
				<div class="card-header"> 
					<div class = 'floatleft'>
						<h1 class='text-dark fw-bolder fs-2 margintop7'>Product Divisions</h1>
						</div> 
						<div class = 'floatleft'>
						<a  href ='/appadmin/addbranchtype'
						class='edit btn btn-primary btn-sm margintop7 paddtop6 bold left'> Add Product Division  
						</a>
					</div>
				</div>

                <div class="card-body">
					<form method = 'post' action = "/appadmin/div/deleteall">
